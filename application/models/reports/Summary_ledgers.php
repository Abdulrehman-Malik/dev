...
class Summary_ledgers extends Summary_report
{
	protected function _get_data_columns()
	{
		return array(
			array('company' => $this->lang->line('reports_supplier')),
	...
	protected function _from()
	{
		...
		$this->db->join('suppliers AS suppliers', 'items.supplier_id = suppliers.person_id', 'left outer');
	}
