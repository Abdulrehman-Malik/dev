	...
	<div class="col-md-4">
		<div class="panel panel-primary">
			...
			<div class="list-group">
				...
				{
					//remove the reports name from graphical report section
					if (preg_match('/reports_/', $grant['permission_id']) && !preg_match('/(inventory|receivings|gl|ledgers)/', $grant['permission_id']))
					{
	...
	<div class="col-md-4">
		<div class="panel panel-primary">
			...
			<div class="list-group">
				...
				show_report_if_allowed('specific', 'suppliersgls', $person_id, 'reports_suppliersgls');
				?>
			 </div>
		</div>
