...
class Receiving_lib
{
	...
	//payment supplier set and get
	public function get_psupplier()
	{
		if(!$this->CI->session->userdata('recv_psupplier'))
		{
			$this->set_psupplier(-1);
		}

		return $this->CI->session->userdata('recv_psupplier');
	}

	public function set_psupplier($supplier_id)
	{
		$this->CI->session->set_userdata('recv_psupplier', $supplier_id);
	}

	public function remove_psupplier()
	{
		$this->CI->session->unset_userdata('recv_psupplier');
	}
	//payment supplier set and get
