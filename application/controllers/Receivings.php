...
class Receivings extends Secure_Controller
{
	...
	public function complete()
	{
		...
		$data['receiving_id'] = 'RECV ' . $this->Receiving->save($data['cart'], $supplier_id, $employee_id, $data['comment'], $data['reference'], $data['payment_type'], $data['stock_location'],$data['amount_tendered'],$data['mode']);
