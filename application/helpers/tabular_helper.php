...
/*
Get the header for the item rate tabular view
*/
function get_item_rate_manage_table_headers()
{
	$CI =& get_instance();

	$headers = array(
		array('rate_id' => $CI->lang->line('expenses_categories_category_id')),
		array('rate_name' => $CI->lang->line('expenses_categories_name')),
		array('rate_description' => $CI->lang->line('expenses_categories_description'))
	);
...
/*
Gets the html data row for the item rate 
*/
function get_item_rate_data_row($expense_category)
{
	$CI =& get_instance();
	...
	return array (
		'rate_id' => $expense_category->rate_id,
		'rate_name' => $expense_category->rate_name,
		'rate_description' => $expense_category->rate_description,
		'edit' => anchor($controller_name."/view/$expense_category->rate_id", '<span class="glyphicon glyphicon-edit"></span>',
			array('class'=>'modal-dlg', 'data-btn-submit' => $CI->lang->line('common_submit'), 'title'=>$CI->lang->line($controller_name.'_update'))
		)
	);
}
